...
export default function LalotAdsPage() {
  const brandId = "lalot";
  const brandName = "Lalot Restaurant";
  
  const [adConfig, setAdConfig] = useState({
    bannerUrl: "https://drive.google.com/uc?export=view&id=1LlT-v_QpX7H_G2gX4t_H-Y5U0W_Z1q",
    redirectUrl: "https://lalot.vn",
  ...
  return (
    <div className="p-10 max-w-[1600px] mx-auto min-h-screen bg-[#F8FAFC]">
      ...
      <div className="mb-12">
        <h1 className="text-4xl font-black text-gray-900 tracking-tight leading-tight">Dashboard Quảng cáo <span className="text-indigo-600">Lá Lốt</span></h1>
        <p className="text-sm font-bold text-gray-400 mt-2 uppercase tracking-widest">Multi-tenant Managed Profile / Fine Dining & WiFi Infrastructure</p>
      </div>
